        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-2 p-1.5 bg-slate-100/80 rounded-2xl border border-slate-200">
            <button
              ...
              className={`flex flex-col sm:flex-row items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl font-bold text-xs sm:text-sm transition-all ${
                role === 'receptionist'
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-semibold text-text-heading uppercase mb-1.5">
              {role === 'admin' ? 'Email / Username' : 'Username'}
            </label>
            <div className="relative">
              ...
              <input
                ...
                placeholder={role === 'admin' ? 'Enter admin email' : 'Enter username'}
